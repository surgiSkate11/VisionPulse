...
class ExerciseAdmin(admin.ModelAdmin):
    ...
    def completion_rate(self, obj):
        ...
        return format_html(
            '<span style="color: {}; font-weight: bold;">{:.0f}%</span> <span style="color: #999;">({}/{})</span>',
            color, rate, completed, total
        )
        ...
        <div style="background: #f5f5f5; padding: 15px; border-radius: 5px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                    ...
                    <td style="padding: 5px;">{completed} ({(completed/total*100):.1f}%)</td>
                </tr>
                <tr>
                    <td style="padding: 5px;"><strong>En progreso:</strong></td>
                    <td style="padding: 5px;">{total - completed}</td>
                </tr>
                <tr>
                    <td style="padding: 5px;"><strong>Calificación promedio:</strong></td>
                    <td style="padding: 5px;">{"⭐" * int(avg_rating)} {avg_rating:.1f}/5.0</td>
                </tr>
            </table>
        </div>
        '''
...
class ExerciseSessionAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user__username', 'user__email', 'exercise__title', 'feedback')
    readonly_fields = (
        'user', 
        'exercise', 
        'started_at', 
    ...
    def duration_display(self, obj):
        ...
        return format_html(
            '<span style="color: {};">{} {:.1f}/{:.1f} min</span>',
        ...
        <div style="background: #f5f5f5; padding: 15px; border-radius: 5px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="padding: 5px;">{expected_seconds} segundos ({round(expected_seconds/60, 1)} min)</td>
                </tr>
                <tr>
                    <td style="padding: 5px;"><strong>Duración real:</strong></td>
                    <td style="padding: 5px;">{actual_seconds} segundos ({round(actual_seconds/60, 1)} min)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding: 5px;">{"✓ Sí" if obj.is_fully_completed() else "✕ No"}</td>
                </tr>
            </table>
        </div>
        '''
