...
class MenuListView(SidebarMenuMixin, PermissionMixin, ListViewMixin, ListView):
...
class MenuCreateView(SidebarMenuMixin, PermissionMixin, CreateViewMixin, CreateView):
    model = Menu
...
class MenuUpdateView(SidebarMenuMixin, PermissionMixin, UpdateViewMixin, UpdateView):
    model = Menu
    template_name = 'security/menus/form.html'
    form_class = MenuForm
    success_url = reverse_lazy('security:menu_list')
...
class MenuDeleteView(SidebarMenuMixin, PermissionMixin, DeleteViewMixin, DeleteView):
    model = Menu
