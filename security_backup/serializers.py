...
from apps.core.models import Achievement, StudentAchievement as UserAchievement
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'full_name', 'bio', 'avatar', 'user_type', 'study_level',
            ...
            'total_study_time', 'tasks_completed', 'notes_created',
            'is_premium_active', 'date_joined', 'last_activity'
        ]
        read_only_fields = [
            'id', 'uuid', 'total_xp', 'current_level', 'current_streak',
            'longest_streak', 'total_study_time', 'tasks_completed',
            'notes_created', 'date_joined', 'last_activity'
        ]
